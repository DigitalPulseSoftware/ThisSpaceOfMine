...
namespace tsom
{
	class ClientCharacterController;
	class Planet;

	class TSOM_CLIENTLIB_API ClientCharacter
	{
		public:
			...
			void SetLastInputs(const PlayerInputs& lastInputs);
		...
		private:
			std::shared_ptr<ClientCharacterController> m_controller;
			entt::handle m_entity;
	};
}

#include <ClientLib/ClientCharacter.inl>
