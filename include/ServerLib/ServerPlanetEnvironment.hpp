...
namespace tsom
{
	...
	{
		public:
			ServerPlanetEnvironment(ServerInstance& serverInstance, std::string generatorName, std::filesystem::path savePath, Nz::UInt32 seed, const Nz::Vector3ui& chunkCount, float cellSize = 1.f, float cornerRadius = 16);
